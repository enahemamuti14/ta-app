...
<div class="absolute bottom-0 top-28 left-44">
    <div class="container mx-auto w-screen max-w-6xl">
        <a href="{{ Route('showmenu') }}" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block">Kembali</a>
        <h1 class="text-2xl font-bold mb-4">Edit Menu</h1>

        <form action="{{ route('tenant.updateMenu', $menu->id) }}" method="POST" class="bg-white shadow-md rounded p-4 mb-4">
            @csrf
            @method('PUT')
            <div class="mb-4">

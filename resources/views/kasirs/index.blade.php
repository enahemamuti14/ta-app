            ...
            <div class="p-4">
                @foreach($tenants as $tenant)
                    <div class="flex justify-between items-center mb-4">
                        ...
                        @if($tenant->menus->count() > 3)
                        <a href="{{ route('tenant.menus.all', ['id' => $tenant->id]) }}" class="text-blue-900 hover:underline">See All</a>
                        @endif
                    </div>
                    <div class="flex flex-wrap gap-4 mb-8">
                        @php
                            $menus = $tenant->menus->take(3); // Ambil hanya 3 menu pertama
                        @endphp
